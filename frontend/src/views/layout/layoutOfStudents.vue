<template>
  <div class="layout-container">
    <Header/>
    <el-row class="main-row" :gutter="0">
      <el-col :span="isCollapse ? 1 : 4" class="left-col">
        ...
        >
          ...
          <el-menu-item class="menu-item" index="/homework">
            <template #title>
              <span class="title">作业</span>
            </template>
          </el-menu-item>
          <el-menu-item class="menu-item" index="/attendance">
            <template #title>
              <span class="title">出勤</span>
            </template>
          </el-menu-item>
          <el-menu-item class="menu-item" index="/discussion">
            <template #title>
